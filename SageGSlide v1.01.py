...
TOKEN_FILE = 'client_secret_310838804871-3kiaqjaa79un6ttbcf3p5uq36sjft73o.apps.googleusercontent.com'  # Your token.json file
...
time_label = tk.Label(root, fg="white", bg="black", font=("Arial", 50), anchor="se")
